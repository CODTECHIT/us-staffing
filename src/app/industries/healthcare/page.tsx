...
export const metadata: Metadata = {
  title: 'Healthcare Industry Staffing | Maxera Talent',
  description: 'Providing qualified clinical and administrative professionals who meet strict compliance requirements.',
};
...
export default function HealthcareIndustryPage() {
  return (
    <>
      <Hero
        title="Healthcare"
        subtitle="Empowering Care with Exceptional Medical Professionals."
        backgroundImage="/images/industry-health.jpg"
        cta1={{ label: 'View Jobs', href: '/jobs?industry=Healthcare' }}
        compact
      />
              ...
              <ScrollReveal direction="left">
                <div className="mb-10">
                  ...
                  <p className="text-xl text-gray-600 leading-relaxed mb-6 font-light">
                    We connect healthcare systems, clinics, and research facilities with the compassionate and skilled professionals needed to deliver high-quality patient care.
                  </p>
                  <p className="text-lg text-gray-500 leading-relaxed italic border-l-4 border-amber-400 pl-6">
                    Navigating the complex regulatory and compliance landscape of healthcare requires more than just recruitment—it requires a partner who understands the stakes.
                  </p>
                </div>
                ...
                <div className="mb-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      'Critical shortage of nursing and specialized clinical staff',
                      'Strict credentialing and compliance requirements',
                      'Burnout and high turnover in high-stress environments',
                      'Integration of advanced healthcare IT and legacy systems'
                    ].map((challenge, index) => (
                ...
                <div className="p-10 rounded-[3rem] bg-navy-900 text-white shadow-2xl relative overflow-hidden">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                    {[
                      ...
                      'Rapid response teams for emergency staffing needs',
                      'Deep understanding of clinical environment cultures',
                      'Ongoing compliance management and risk mitigation'
                    ].map((solution, index) => (
