...
export const metadata: Metadata = {
  title: 'Engineering Industry Staffing | Maxera Talent',
  description: 'Specialized candidates for electrical, mechanical, civil, and industrial engineering projects.',
};
...
export default function EngineeringIndustryPage() {
  return (
    <>
      <Hero
        title="Engineering"
        subtitle="Building the Future with Precision Engineering Talent."
        backgroundImage="/images/industry-engineering.jpg"
        cta1={{ label: 'View Jobs', href: '/jobs?industry=Engineering' }}
        compact
      />
              ...
              <ScrollReveal direction="left">
                <div className="mb-14">
                  ...
                  <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-navy-900 mb-8 font-heading leading-tight">
                    Powering Progress in <span className="text-teal-500 whitespace-nowrap">Engineering</span>
                  </h2>
                  <p className="text-xl text-gray-600 leading-relaxed mb-6 font-light">
                    We bridge the gap between complex technical requirements and the brilliant minds capable of solving them, from structural integrity to advanced manufacturing.
                  </p>
                  <p className="text-lg text-gray-500 leading-relaxed italic border-l-4 border-amber-400 pl-6">
                    Engineering projects demand specialized knowledge and a commitment to safety. We vet our professionals for both.
                  </p>
                </div>
                ...
                <div className="mb-16">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      'Global shortage of P.E. licensed engineers in civil and structural',
                      'Rapid integration of AI and automation in manufacturing',
                      'High infrastructure project demand exceeding local talent pools',
                      'Strict safety and regulatory compliance across diverse states'
                    ].map((challenge, index) => (
                ...
                <div className="p-10 rounded-[3rem] bg-navy-900 text-white shadow-2xl relative overflow-hidden">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                    {[
                      'Targeted search for specialized licensed professionals',
                      'Deep understanding of engineering project lifecycles',
                      'Rigorous safety and compliance background checks',
                      'Scaleable staffing for large-scale infrastructure projects'
                    ].map((solution, index) => (
              ...
              <ScrollReveal direction="right">
                <div className="bg-gray-50 rounded-[2.5rem] p-10 border border-gray-100 shadow-sm">
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed mb-8">
                    We don&apos;t just recruit; we partner. Our deep understanding of Engineering enables us to identify the specialized talent that others miss.
                  </p>
