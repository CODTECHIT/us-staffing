...
export const metadata: Metadata = {
  title: 'Technology Industry Staffing | Maxera Talent',
  description: 'Specialized staffing solutions for software development, cloud infrastructure, and IT operations.',
};
...
export default function TechnologyIndustryPage() {
  return (
    <>
      <Hero
        title="Technology"
        subtitle="Fueling Innovation with Elite Technical Talent."
        backgroundImage="/images/industry-tech.jpg"
        cta1={{ label: 'View Jobs', href: '/jobs?industry=Technology' }}
        compact
      />
              ...
              <ScrollReveal direction="left">
                <div className="mb-14">
                  ...
                  <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-navy-900 mb-8 font-heading leading-tight">
                    Powering Progress in <span className="text-teal-500 whitespace-nowrap">Technology</span>
                  </h2>
                  <p className="text-xl text-gray-600 leading-relaxed mb-6 font-light">
                    From startups to Fortune 500 enterprises, we help technology organizations find the specialists who can build, scale, and secure the next generation of digital products.
                  </p>
                  <p className="text-lg text-gray-500 leading-relaxed italic border-l-4 border-amber-400 pl-6">
                    Our team specializes in placing engineers, architects, and data professionals who don&apos;t just code, but drive business outcomes through technical excellence.
                  </p>
                </div>
                ...
                <div className="mb-16">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      'Extremely competitive market for AI and Cloud specialists',
                      'Rapidly evolving tech stacks requiring continuous learning',
                      'High turnover rates due to a plethora of options for candidates',
                      'Difficulty in assessing true senior-level expertise'
                    ].map((challenge, index) => (
                ...
                <div className="p-10 rounded-[3rem] bg-navy-900 text-white shadow-2xl relative overflow-hidden">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                    {[
                      'Access to a proprietary network of passive tech talent',
                      'Technical vetting by experienced industry practitioners',
                      'Strategic advice on market rates and benefit packages',
                      'Flexible hiring models to suit agile development cycles'
                    ].map((solution, index) => (
              ...
              <ScrollReveal direction="right">
                <div className="bg-gray-50 rounded-[2.5rem] p-10 border border-gray-100 shadow-sm">
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed mb-8">
                    We don&apos;t just recruit; we partner. Our deep understanding of Technology enables us to identify the specialized talent that others miss.
                  </p>
