  ...
  return (
    <section className="relative py-12 overflow-hidden">
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, rgba(11, 35, 64, 0.92) 0%, rgba(6, 21, 39, 0.88) 100%)' }}
      />

      {/* Content */}
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <ScrollReveal>
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-6 drop-shadow-lg">
            {title}
          </h2>
